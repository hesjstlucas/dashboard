...
export const GUIDELINES = [
  ...
  },
  {
    ...
    content:
      "Players, calls, reports, and records are entered by staff so the portal can run without external server setup.",
    links: []
  },
  {
    id: "g4",
...
export const activitySeed = [
  {
    ...
    note: "Departments, records, applications, manual calls, and rank controls are ready.",
    when: "Today"
  }
];
...
export const emergencyCallsSeed = [
  {
    id: "call-demo-1",
    team: "Police",
    caller: "Walk-in report",
    callNumber: "PX-911-1",
    description: "Suspicious vehicle reported near the county gas station.",
    positionDescriptor: "Liberty County",
    startedAt: "Manual seed",
    source: "manual"
  }
];
...
export const modCallsSeed = [
  {
    id: "mod-demo-1",
    caller: "Staff request",
    moderator: "Unassigned",
    reason: "Scene review needed",
...
export const integrationsSeed = [
  {
    id: "int1",
    title: "Manual call center",
    status: "Ready",
    description: "911 calls, mod calls, command notes, and player sightings are entered by staff in the portal."
  },
  {
    id: "int2",
  ...
  },
  {
    ...
    description: "Keeps records in local storage until you connect a production database."
  }
];
...
export const settingsSeed = [
  ...
  },
  {
    ...
    name: "Player intake",
    value: "Manual entry",
    note: "Staff add players to the searchable vault when they need records or department history."
  },
  {
    id: "set3",
...
export const initialState = {
  ...
  erlcServer: {
    name: "Paralix Operations",
    currentPlayers: playersSeed.length,
    maxPlayers: null,
    queue: 0,
    source: "manual"
  }
...
export function createEmergencyCallRecord(payload, author) {
  return {
    id: `call-${Date.now()}`,
    team: payload.team || "Police",
    caller: payload.caller || "Unknown caller",
    callNumber: payload.callNumber || `PX-911-${Date.now().toString().slice(-4)}`,
    description: payload.description || "No description provided.",
    positionDescriptor: payload.positionDescriptor || "Unknown location",
...
export function createModCallRecord(payload, author) {
  return {
    id: `mod-${Date.now()}`,
    caller: payload.caller || "Unknown caller",
    moderator: payload.moderator || "Unassigned",
